				            ...
				            <div class="row no-gutters">
				                <div class="col-10 col-md-9 col-lg-10">
				                    <div class="form-group input-group-lg mb-0">
				                        <input type="search" name="query" class="form-control backend-search-input border border-right-0" placeholder="Search upcomings" autocomplete="on" value="<?= empty($searchQuery) ? '' : $searchQuery; ?>">
				                    </div>
				                </div>
