			...
			<div class="row">
				...
				<div class="col s12 m12 l8">
					<?php if(empty($singleNews)): ?>
						<div class="row">
						   <div class="col s12">
						   	   <div class="qt-black-bg" style="color: #fff; display: block; padding: 10px 15px;">News Not Found</div>
						   </div>
						</div>
					<?php else: ?>
						<div class="row">
								...
								<div class="qt-part-archive-item qt-featured">
									<div class="qt-item-header">
										<div class="qt-header-top">
											<ul class="qt-tags">
												<li>
													<a href="javascript:;">Local News</a>
												</li>
											</ul>
										</div>
					...
					<?php endif; ?>
					<div class="">
						<h3 style="margin-bottom: 10px;">Related News</h3>
