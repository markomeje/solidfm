		...
		<div class="float-right px-3 position-relative backend-area">
			...
			<div class="buttons mb-4">
				<div class="d-flex justify-content-between">
					<div class="bg-dark text-white px-3 rounded cursor-pointer d-flex align-items-center" data-toggle="modal" data-target="#add-category">
						<small class="font-sm">
							<i class="icofont-plus"></i>
						</small>
						<div class="pl-2">Add category</div>
					</div>
					<div class="d-flex">
			...
			<?php if(empty($allCategories)): ?>
				<div class="alert alert-info d-block">No categories yet.</div>
			<?php else: ?>
				<div class="row">
